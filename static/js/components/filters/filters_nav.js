        ...
        return `
            <div class="categories-filter-container">
                ...
                <div class="filter-section">
                    <a href="/" class="filter-link main-filter" data-filter="all">
                ...
                <div class="filter-section">
                    <h3><i class="fas fa-user-circle"></i> My Posts</h3>
                    <ul class="filter-list">
                        <li>
                            <a href="/created" class="filter-link" data-filter="created">
                                <i class="fas fa-pencil-alt"></i>
                                <span>Created by me</span>
                            </a>
                        </li>
                        <li>
                            <a href="/liked" class="filter-link" data-filter="liked">
                                <i class="fas fa-heart"></i>
                                <span>Reacted by me</span>
                            </a>
                        </li>
                        <li>
                            <a href="/commented" class="filter-link" data-filter="commented">
                ...
                <div class="filter-section">
                    ...
                    <ul class="category-list">
                        <li>
                            <a href="/category?name=Tech" class="filter-link" data-category="Tech">
                                <i class="fas fa-microchip"></i>
                                <span>Tech</span>
                            </a>
                        </li>
                        <li>
                            <a href="/category?name=Programming" class="filter-link" data-category="Programming">
                                <i class="fas fa-code"></i>
                                <span>Programming</span>
                            </a>
                        </li>
                        <li>
                            <a href="/category?name=Business" class="filter-link" data-category="Business">
                                <i class="fas fa-briefcase"></i>
                                <span>Business</span>
                            </a>
                        </li>
                        <li>
                            <a href="/category?name=Lifestyle" class="filter-link" data-category="Lifestyle">
                                <i class="fas fa-coffee"></i>
                                <span>Lifestyle</span>
                            </a>
                        </li>
                        <li>
                            <a href="/category?name=Football" class="filter-link" data-category="Football">
                                <i class="fas fa-futbol"></i>
                                <span>Football</span>
                            </a>
                        </li>
                        <li>
                            <a href="/category?name=Politics" class="filter-link" data-category="Politics">
                                <i class="fas fa-landmark"></i>
                                <span>Politics</span>
                            </a>
                        </li>
                        <li>
                            <a href="/category?name=General%20News" class="filter-link" data-category="General News">
